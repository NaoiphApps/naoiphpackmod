...
public class NaoiphRedTowerStructure extends NaoiphPackElements.ModElement {
	public NaoiphRedTowerStructure(NaoiphPackElements instance) {
		super(instance, 17);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("naoiphpack", "redtower"));
						if (template == null)
							return false;
