...
public class NaoiphHotAshStructure extends NaoiphPackElements.ModElement {
	public NaoiphHotAshStructure(NaoiphPackElements instance) {
		super(instance, 13);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 20000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("naoiphpack", "hotash"));
						if (template == null)
							return false;
