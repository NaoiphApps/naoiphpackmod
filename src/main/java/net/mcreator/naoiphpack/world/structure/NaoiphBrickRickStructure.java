...
package net.mcreator.naoiphpack.world.structure;
...
public class NaoiphBrickRickStructure extends NaoiphPackElements.ModElement {
	public NaoiphBrickRickStructure(NaoiphPackElements instance) {
		super(instance, 11);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 20000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("naoiphpack", "brickrick"));
						if (template == null)
							return false;
