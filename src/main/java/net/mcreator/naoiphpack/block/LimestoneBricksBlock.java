...
public class LimestoneBricksBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:limestonebricks")
	public static final Block block = null;
	public LimestoneBricksBlock(NaoiphPackElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("limestonebricks");
		}
