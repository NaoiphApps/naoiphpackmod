...
public class SlateBrickBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:slatebrick")
	public static final Block block = null;
	public SlateBrickBlock(NaoiphPackElements instance) {
		super(instance, 48);
	}
