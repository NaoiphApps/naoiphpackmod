...
import net.mcreator.naoiphpack.procedures.BellBlockRedstoneOnProcedure;
...
public class BellBlockBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:bellblock")
	public static final Block block = null;
	public BellBlockBlock(NaoiphPackElements instance) {
		super(instance, 144);
	}
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				{
					...
					BellBlockRedstoneOnProcedure.executeProcedure($_dependencies);
				}
			} else {
			}
		}
