...
public class NaoiphSlateBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:slate")
	public static final Block block = null;
	public NaoiphSlateBlock(NaoiphPackElements instance) {
		super(instance, 1);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 16), Placement.COUNT_RANGE, new CountRangeConfig(10, 0, 0, 69)));
		}
	}
}
