...
public class SlateBrickSlabBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:slatebrickslab")
	public static final Block block = null;
	public SlateBrickSlabBlock(NaoiphPackElements instance) {
		super(instance, 50);
	}
