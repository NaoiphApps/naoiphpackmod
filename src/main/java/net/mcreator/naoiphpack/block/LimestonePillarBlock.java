...
public class LimestonePillarBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:limestonepillar")
	public static final Block block = null;
	public LimestonePillarBlock(NaoiphPackElements instance) {
		super(instance, 141);
	}
