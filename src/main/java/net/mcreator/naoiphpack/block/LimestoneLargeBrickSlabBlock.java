...
public class LimestoneLargeBrickSlabBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:limestonelargebrickslab")
	public static final Block block = null;
	public LimestoneLargeBrickSlabBlock(NaoiphPackElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("limestonelargebrickslab");
		}
