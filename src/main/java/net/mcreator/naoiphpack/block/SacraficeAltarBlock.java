...
import net.mcreator.naoiphpack.gui.SacraficeGUIGui;
...
public class SacraficeAltarBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:sacraficealtar")
	public static final Block block = null;
	public SacraficeAltarBlock(NaoiphPackElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sacraficealtar");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("don't put jimmy on this"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Sacrafice Altar");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new SacraficeGUIGui.GuiContainerMod(id, inventory,
