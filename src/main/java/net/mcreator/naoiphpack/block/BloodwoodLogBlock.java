...
public class BloodwoodLogBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:bloodwoodlog")
	public static final Block block = null;
	public BloodwoodLogBlock(NaoiphPackElements instance) {
		super(instance, 118);
	}
