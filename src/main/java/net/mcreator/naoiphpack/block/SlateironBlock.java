...
public class SlateironBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:slateiron")
	public static final Block block = null;
	public SlateironBlock(NaoiphPackElements instance) {
		super(instance, 100);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("slateiron", "slateiron", blockAt -> {
