...
public class NaoiphRedBlockBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:naoiphredblock")
	public static final Block block = null;
	public NaoiphRedBlockBlock(NaoiphPackElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("naoiphredblock");
		}
