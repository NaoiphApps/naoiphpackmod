...
import net.mcreator.naoiphpack.procedures.RedweedPlantDestroyedByPlayerProcedure;
...
public class RedweedBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:redweed")
	public static final Block block = null;
	public RedweedBlock(NaoiphPackElements instance) {
		super(instance, 115);
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				RedweedPlantDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
