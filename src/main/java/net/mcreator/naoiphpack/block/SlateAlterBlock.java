...
public class SlateAlterBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:slatealter")
	public static final Block block = null;
	public SlateAlterBlock(NaoiphPackElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockClicked(BlockState state, World world, BlockPos pos, PlayerEntity entity) {
			...
			int z = pos.getZ();
			{
				...
				SlateAlterPlayerStartsToDestroyProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Slate Altar");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new SlateAltarGUIGui.GuiContainerMod(id, inventory,
