...
public class LimestoneLargeBrickBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:limestonelargebrick")
	public static final Block block = null;
	public LimestoneLargeBrickBlock(NaoiphPackElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("limestonelargebrick");
		}
