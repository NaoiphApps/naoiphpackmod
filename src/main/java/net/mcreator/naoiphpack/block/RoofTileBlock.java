...
public class RoofTileBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:rooftile")
	public static final Block block = null;
	public RoofTileBlock(NaoiphPackElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(),
					Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).lightValue(0));
			setRegistryName("rooftile");
		}
