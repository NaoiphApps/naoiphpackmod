...
public class MountainGrassBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:mountaingrass")
	public static final Block block = null;
	public MountainGrassBlock(NaoiphPackElements instance) {
		super(instance, 133);
	}
