...
public class SlateBrickStairsBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:slatebrickstairs")
	public static final Block block = null;
	public SlateBrickStairsBlock(NaoiphPackElements instance) {
		super(instance, 49);
	}
