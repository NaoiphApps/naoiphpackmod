...
public class TrialBlockBlock extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:trialblock")
	public static final Block block = null;
	public TrialBlockBlock(NaoiphPackElements instance) {
		super(instance, 83);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("THIS ISN'T MEANT FOR SURVIVAL YET"));
		}
