...
public class RedquartzAssaultRifleItem extends NaoiphPackElements.ModElement {
	@ObjectHolder("naoiphpack:redquartzassaultrifle")
	public static final Item block = null;
	@ObjectHolder("naoiphpack:entitybulletredquartzassaultrifle")
	public static final EntityType arrow = null;
	public RedquartzAssaultRifleItem(NaoiphPackElements instance) {
		super(instance, 101);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletredquartzassaultrifle").setRegistryName("entitybulletredquartzassaultrifle"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(NaoiphPackItemGroup.tab).maxDamage(300));
			setRegistryName("redquartzassaultrifle");
		}
