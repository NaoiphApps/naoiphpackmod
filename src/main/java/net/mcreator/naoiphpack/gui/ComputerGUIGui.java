...
public class ComputerGUIGui extends NaoiphPackElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public ComputerGUIGui(NaoiphPackElements instance) {
		super(instance, 86);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("computergui"));
	}
