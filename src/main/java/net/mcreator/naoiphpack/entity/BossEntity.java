...
public class BossEntity extends NaoiphPackElements.ModElement {
	public static EntityType entity = null;
	public BossEntity(NaoiphPackElements instance) {
		super(instance, 68);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f)).build("boss")
						.setRegistryName("boss");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -13108, -13421824, new Item.Properties().group(NaoiphPackItemGroup.tab)).setRegistryName("boss"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("naoiphpack:textures/oss.png");
				}
			};
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				BossAttackProcedure.executeProcedure($_dependencies);
			}
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			int z = (int) this.posZ;
			{
				...
				$_dependencies.put("world", world);
				BossTouchProcedure.executeProcedure($_dependencies);
			}
		}
