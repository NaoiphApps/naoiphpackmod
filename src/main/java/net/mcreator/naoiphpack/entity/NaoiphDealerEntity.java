...
import net.mcreator.naoiphpack.procedures.OpenGUIProcedure;
import net.mcreator.naoiphpack.itemgroup.NaoiphPackItemGroup;
import net.mcreator.naoiphpack.item.NaoiphGrassDrugItem;
import net.mcreator.naoiphpack.NaoiphPackElements;

@NaoiphPackElements.ModElement.Tag
public class NaoiphDealerEntity extends NaoiphPackElements.ModElement {
	public static EntityType entity = null;
	public NaoiphDealerEntity(NaoiphPackElements instance) {
		super(instance, 6);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.95f)).build("naoiphdealer")
						.setRegistryName("naoiphdealer");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(NaoiphPackItemGroup.tab)).setRegistryName("naoiphdealer"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			MobRenderer customRender = new MobRenderer(renderManager, new VillagerModel(0), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("naoiphpack:textures/ealer.png");
				}
			};
			return customRender;
		});
	...
	public static class CustomEntity extends VillagerEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 15;
			setNoAI(false);
			setCustomName(new StringTextComponent("Grass Dealer"));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(NaoiphGrassDrugItem.block, (int) (1)));
		}
		...
		public boolean processInteract(PlayerEntity entity, Hand hand) {
			...
			ItemStack itemstack = entity.getHeldItem(hand);
			{
				...
				OpenGUIProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
